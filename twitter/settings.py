...
SECRET_KEY = '_yx&z#o+4l0i_zvcv^8-d_#2r%lu&tiw1is2xwn1ol$)tztq!v'
...
# Testing should not depend on third party cloud service,
#  otherwise could be slow or even failed.
...
AWS_STORAGE_BUCKET_NAME = 'django-twitter-plenilune'
...
# DO NOT pip install memcache or django-memcached (out-dated)
CACHES = {
    'default': {
        'BACKEND': 'django.core.cache.backends.memcached.MemcachedCache',
        'LOCATION': '127.0.0.1:11211',
        'TIMEOUT': 86400, # default TTL(time to live)
    },
    'testing': {
        'BACKEND': 'django.core.cache.backends.memcached.MemcachedCache',
        'LOCATION': '127.0.0.1:11211',
...
# 因为redis非testing的时候用了1，为了区分，celery就用2
